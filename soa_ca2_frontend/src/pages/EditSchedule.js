...
function EditSchedule() {
    ...
    useEffect(() => {
        const getSchedule = async () => {
            try {
                const response = await fetch(`api/Schedules/${id}`, sessionStorage.getItem('authToken'));
    ...
    const handleEditSchedule = async (e) => {
        e.preventDefault();
        try {
            await fetchEdit(`api/Schedules/${id}`, sessionStorage.getItem('authToken'), { courseId, instructorId, roomId, date, timeSlot, "isAutoGenerated": false, generatedBy: sessionStorage.getItem('role') });
